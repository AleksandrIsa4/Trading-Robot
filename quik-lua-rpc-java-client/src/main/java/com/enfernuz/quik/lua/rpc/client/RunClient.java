package com.enfernuz.quik.lua.rpc.client;
...
public class RunClient {
    ...
    @Autowired
    public RunClient(@Value("${logic-server.url}") String serverUrl, RestTemplateBuilder builder) {
        this.rest = builder
    ...
    public boolean getRunLogic() {
        ...
        ResponseEntity<Object> objectResponseEntity = makeAndSendRequest(HttpMethod.GET, "/runRPC", null, null, null);
