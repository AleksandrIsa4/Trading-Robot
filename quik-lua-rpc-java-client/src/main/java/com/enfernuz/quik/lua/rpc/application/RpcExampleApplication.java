...
public class RpcExampleApplication {
    ...
    public static void main(final String[] args) {
        ...
        try (final ZmqTcpQluaRpcClient rpcClient = ZmqTcpQluaRpcClient.newInstance(config)) {
            ...
            GetParamEx.Args arggg=new GetParamEx.Args("TQBR","VTBR","HIGH");
            log.info("Результат в GetParamEx.Args: {}.", arggg);
            final GetParamEx.ParamEx result2 = rpcClient.qlua_getParamEx(arggg);
            log.info("Результат выполнения удалённой процедуры 'message12312313': {}.", result2);
